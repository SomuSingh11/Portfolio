...
export const STACK = [
  ...
  {
    category: "AI / ML",
    items: ["Google Gemini API", "RAG pipelines"],
  },
  {
    category: "Embedded",
    items: ["ESP32", "C++ systems"],
  },
  {
    category: "Tools",
    items: ["Git", "Postman", "Clerk", "Convex", "Linux"],
  },
];
...
export const INTERESTS = {
  games: [
    ...
    },
    {
      name: "Arkham City",
      image:
        "https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExcmV1eml3ZDFieTJ4aWNrYTJ2MmxqbDdnNW1zeTIzNzU1emw4eSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/MQHfI7JjYh75m/giphy.gif",
    },
    {
      name: "GTA V",
      image:
