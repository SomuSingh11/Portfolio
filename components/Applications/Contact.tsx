...
export default function Contact() {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      action: () => window.open("mailto:john@example.com"),
    },
  ];
          ...
          >
            ...
            {submitted && (
              <motion.div
                ...
                className="mt-4 p-3 bg-green-600/20 border border-green-600/30 text-green-400 rounded text-sm"
              >
              ...
              <div className="space-y-3">
                {quickActions.map((action) => (
                  <button
                    ...
                    className="w-full flex items-center space-x-3 p-3 bg-gray-700 hover:bg-gray-600 rounded transition-colors text-left"
                  >
